...
public:
	...
	void minimapRender(HDC mapHdc, int destX, int destY, int width, int height, HDC sourHdc, int startX, int startY, int endX, int endY);
	...
	//프레임 여부
	inline int getIsFrame() { return _imageInfo->isFrame; }

	//맥스프레임 x,y
	inline int getMaxFrameX() { return _imageInfo->maxFrameX; }
	inline int getMaxFrameY() { return _imageInfo->maxFrameY; }

	void setColorImage(COLORREF setColor, COLORREF transColor);
};
