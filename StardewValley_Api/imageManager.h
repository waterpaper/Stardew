...
public:
	...
	bool deleteAll();
	//이미지 사이즈 조절
	void setImageReSize(string strKey, int x, int y);
	...
	void minimapRender(string strKey, HDC mapHdc, int destX, int destY, int width, int height, HDC sourHdc, int startX, int startY, int endX, int endY);

	void setColorImage(string strKey, COLORREF setColor, COLORREF transColor);
};